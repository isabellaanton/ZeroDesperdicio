    ...
    <SafeAreaView style={s.safe}>
      ...
      <View style={s.statsContainer}>
        <View style={[s.statCard, { backgroundColor: VERDE }]}>
          <Text style={s.statNumDestaque}>23</Text>
          <Text style={s.statLabelDestaque}>recebidas</Text>
        </View>
        ...
        <View style={s.statCard}>
          <Text style={s.statNum}>52kg</Text>
      ...
      >
        <Text style={s.secaoTitulo}>{RECEBIDAS.length} doações recebidas</Text>
            ...
            <View style={s.cardBody}>
              <View style={s.cardTopo}>
                ...
                <View style={s.badgeConcluido}>
                  <Text style={s.badgeConcluidoTexto}>Recebido</Text>
                </View>
              </View>
              <Text style={s.cardDetalhe}>{item.detalhe}</Text>
              <View style={s.cardRodape}>
                <View style={s.cardRodapeItem}>
                  <Ionicons name="storefront-outline" size={13} color={LARANJA} />
                  <Text style={s.cardRodapeTexto}>{item.doador}</Text>
                </View>
                <View style={s.cardRodapeItem}>
...
const s = StyleSheet.create({
  ...
  cardTitulo: { fontSize: 15, fontWeight: '700', color: '#1A1A1A', flex: 1, marginRight: 6 },
  ...
  cardRodape: { flexDirection: 'row', gap: 12, marginTop: 6, flexWrap: 'wrap' },
