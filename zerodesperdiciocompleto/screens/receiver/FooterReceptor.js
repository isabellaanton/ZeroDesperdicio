...
export default function FooterReceptor({ navigation, abaAtual }) {
  return (
    <View style={styles.navBar}>
      ...
      <TouchableOpacity style={styles.navItem} onPress={() => navigation?.navigate('MapaDoacoes')} activeOpacity={0.7}>
      ...
      <TouchableOpacity style={styles.navItem} onPress={() => navigation?.navigate('MeusPedidos')} activeOpacity={0.7}>
        <Text style={abaAtual === 'Pedidos' ? styles.navIconeAtivo : styles.navIcone}>🛍️</Text>
        <Text style={abaAtual === 'Pedidos' ? styles.navLabelAtivo : styles.navLabel}>Pedidos</Text>
      </TouchableOpacity>

      <TouchableOpacity style={styles.navItem} onPress={() => navigation?.navigate('InfoReceptor')} activeOpacity={0.7}>
      ...
      <TouchableOpacity style={styles.navItem} onPress={() => navigation?.navigate('PerfilReceptor')} activeOpacity={0.7}>
