...
import { 
  View, Text, ScrollView, TouchableOpacity, StatusBar, SafeAreaView, FlatList, Alert 
} from 'react-native';
import styles from '../../Styles'; 

// 1. IMPORTANDO O FOOTER AQUI (ajuste o caminho de acordo com o seu projeto)
...
export default function TelaHomeDoador({ navigation }) {
  ...
  const handleNovaDoacao = () => {
    if (navigation) {
      navigation.navigate('CadastrarDoacao'); 
    }
  };
  ...
  return (
    <SafeAreaView style={styles.safeArea}>
      ...
      >
        <TouchableOpacity
          style={styles.botaoNovaDoacao} onPress={() => navigation.navigate('CadastrarDoacao')}
        >
