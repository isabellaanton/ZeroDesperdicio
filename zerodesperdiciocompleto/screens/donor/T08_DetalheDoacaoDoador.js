...
export default function DetalheDoacaoDoador({ navigation }) {
  return (
    <SafeAreaView style={styles.safeArea}>
      ...
      <View style={[styles.header, { height: 110 }]}>
        <View style={styles.headerTop}>
          ...
          <Text style={[styles.saudacao, { fontSize: 20 }]}>Detalhes da Doação</Text>
      ...
      >
        <View style={[styles.cardSolicitacao, { backgroundColor: '#FFE4C4', borderColor: '#1A1A1A' }]}>
          ...
          <Text style={styles.descricaoSolicitacao}>Status: <Text style={{color: 'green', fontWeight: 'bold'}}>Ativa</Text></Text>
        </View>
