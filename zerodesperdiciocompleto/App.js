...
// 1. IMPORTANDO O PROVEDOR DE TEMA
import { ThemeProvider } from './ThemeContext'; // Ajuste o caminho se tiver colocado em alguma pasta específica

// Importação das 20 Telas Criadas
...
export default function App() {
  return (
    // 2. ENVOLVENDO A APLICAÇÃO COM O THEME PROVIDER
    <ThemeProvider>
      <NavigationContainer>
        <Stack.Navigator 
