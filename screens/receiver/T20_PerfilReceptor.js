              ...
              {editando ? (
                ...
                <View style={{ marginTop: 10 }}>
                  ...
                  <View style={styles.cardSolicitacao}>
                    <InfoRow icone="person-outline" label="Nome Completo" valor={nome} onChange={setNome} autoCapitalize="words" />
                    <InfoRow icone="call-outline" label="Telemóvel / WhatsApp" valor={telefone} onChange={setTelefone} keyboardType="phone-pad" />
